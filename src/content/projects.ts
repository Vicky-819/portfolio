...
export const FEATURED_IDS: FeaturedId[] = [
  "ecommerce-growth",
  "ai-product-ops",
...
export const INDEPENDENT_IDS: IndependentId[] = [
  "flight-deal",
  "vicky-portfolio",
];
...
> = {
  ...
  "flight-deal": {
    ...
    kind: "project",
    tone: "blue",
    href: "/projects/flight-deal-discovery",
  },
  "vicky-portfolio": {
    slug: "vicky-portfolio",
    kind: "project",
    tone: "sage",
    href: "/projects/vicky-portfolio",
  },
  "minimal-ecommerce": {
...
/* Featured case chain: 01 → 02 → 03 → 04 → About (handled in the case view) */
export function getNextProjectId(id: FeaturedId): FeaturedId | null {
  const index = FEATURED_IDS.indexOf(id);
  return index < FEATURED_IDS.length - 1 ? FEATURED_IDS[index + 1] : null;
}

export function workCaseIds(): FeaturedId[] {
  return [...FEATURED_IDS];
}
